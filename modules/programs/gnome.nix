  ...
  config = lib.mkIf cfg.enable {
    dconf.settings = {
      ...
      "org/gnome/desktop/notifications" = {
        show-banners = false; # Disabled for a distraction-free environment.
      ...
      # ════════════════════════════════════════════════════════════════════════════
      #  §18  WELLBEING — BREAK REMINDERS & SCREEN TIME
      # ════════════════════════════════════════════════════════════════════════════
      ...
      "org/gnome/desktop/screen-time-limits" = {
        daily-limit-seconds = gvariant.mkUint32 28800;
      };

      # ════════════════════════════════════════════════════════════════════════════
      #  §19  APPLICATION FOLDERS
      # ════════════════════════════════════════════════════════════════════════════
      ...
      # ════════════════════════════════════════════════════════════════════════════
      #  §20  SEARCH PROVIDERS & LOGIN SCREEN
      # ════════════════════════════════════════════════════════════════════════════
